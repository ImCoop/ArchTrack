...
function kn(n, e = []) {
  if (Object.hasOwnProperty.call(n, "key")) {
    const t = n.parent.copy, r = O(de(t, n.key));
...
function V(n) {
  n.copy || (n.copy = In(n.original, n.options));
}
function Ce(n) {
  if (!ie(n))
    return jt(n);
...
function Sr(n, e) {
  ...
  n.finalities.revoke.length > 1 && n.assignedMap.get(e) && t && On(de(t, e), n.finalities.handledSet, n.options);
}
function ft(n) {
...
const Be = (n, e, t = !1) => {
  ...
  get size() {
    return X(O(this)).size;
  },
  has(n) {
    return X(O(this)).has(n);
  },
  set(n, e) {
    const t = O(this), r = X(t);
  ...
  get(n) {
    var e, t;
    const r = O(this), s = X(r).get(n), i = ((t = (e = r.options).mark) === null || t === void 0 ? void 0 : t.call(e, s, ee)) === ee.mutable;
  ...
  const c = O(a), u = ((s = (r = n.options).mark) === null || s === void 0 ? void 0 : s.call(r, a, ee)) === ee.mutable;
...
const Ir = Reflect.ownKeys(Ge), Cn = /* @__PURE__ */ new WeakSet(), En = {
  get(n, e, t) {
    var r, s;
...
function Or(n, e, t, r, s) {
  var i;
  const o = O(n), a = (i = o?.original) !== null && i !== void 0 ? i : n, c = !!e.length;
  if (o?.operated)
...
function Mn(n) {
  ...
  let s;
  function i() {
    s = r === 2 ? Pt(n) ? new Map(n) : new (Object.getPrototypeOf(n)).constructor(n) : r === 3 ? Array.from(t.setMap.values()) : In(n, t?.options);
  }
  if (t) {
    t.finalized = !0;
    try {
...
function Nn(n, e, t) {
  ...
  const u = Ie(n.eav, [s, i, o])?.[3] ?? Fn(n, a, r), l = [s, i, o, u];
...
function Me(n, e, t, r, s) {
  return e === r || e == null && r == null ? Is(n, t) : r == null ? 1 : e == null ? -1 : Qs(e, r, s);
}
...
function nn(n, e, t, r) {
  const s = n ? Ii(n, e, t) : null, i = j(), o = [j(), e, t], a = [j(), t, e];
  return {
    id: i,
...
const Oi = /* @__PURE__ */ new Set(["create", "update", "merge", "link", "unlink"]), Ci = /* @__PURE__ */ new Set(["link", "unlink"]), Ei = /* @__PURE__ */ new Set(["create", "update", "merge"]), Mi = /* @__PURE__ */ new Set([
  "link",
  "unlink",
  "create",
  "update",
...
function vo({
  ...
  async function A(C, I) {
    ...
    for await (const M of t(z)) {
      ...
      if (M.offset > s) {
        y(I, new q("Stream is corrupted.")), i = !0;
        return;
      }
      d = M.streamId;
      for (const S of f)
      ...
      if (M.files && M.files.length) {
        ...
        for (let E = 0; E < M.files.length; E++) {
          ...
          if (D && (T = fetch(D.url, { signal: S.signal })), !B.ok) {
            if (g++, g > 10) {
              y(I, new q("Unable to process stream."));
              return;
            }
            return { retry: !0 };
          }
  ...
  async function R(C) {
    ...
    for (; I; ) {
      ...
      (await A(
        { ...e, offset: s },
        C
      ))?.retry && (I = !0, z++, M < Date.now() - 3e5 && (z = 0), await new Promise((S) => {
...
const ae = {
  ...
  CLOSED: "closed",
  ERRORED: "errored"
}, ko = 3e4, Io = 3e4, Oo = 200, Co = 1e3 * 60, Eo = {
...
class Uo {
  ...
  constructor(e, t = tr, r = nr, s, i) {
    if (this._EventSource = i, this.config = { ...Eo, ...e }, this.queryCacheLimit = this.config.queryCacheLimit ?? 10, this._pendingTxCleanupTimeout = this.config.pendingTxCleanupTimeout ?? Io, this._pendingMutationCleanupThreshold = this.config.pendingMutationCleanupThreshold ?? Oo, this._log = eo(
      e.verbose || Kt || rr,
      () => this._reactorStats()
    ), this.versions = { ...s || {}, "@instantdb/core": or }, this.config.schema && (this._linkIndex = It(this.config.schema)), !!Po()) {
      if (!e.appId)
...
class Sa {
  ...
  completeIsomorphic = (e, t, r, s) => {
    ...
    const o = !!this.db?._reactor?.config?.schema && ("cardinalityInference" in this.db?._reactor?.config ? !!this.db?._reactor.config?.cardinalityInference : !0), a = new fe(
      ...
      It(this.db?._reactor.config.schema)
    ), c = Se(
      a,
      t,
      o,
...
const na = (n) => JSON.stringify(n), Pe = (n, e = !1) => JSON.stringify([n, e]), _n = (n) => {
  ...
  const b = (w) => {
    ...
    const S = n.subscribeQuery(
      ...
      (T) => {
        ...
        Oe(E && D, "Expected rows and pageInfo"), A(w, {
          data: E,
    ...
    const Z = n.subscribeQuery(
      ...
      (B) => {
        ...
        Oe(W && te, "Expected rows and pageInfo"), g(w, {
          data: W,
          status: "frozen",
  ...
  return m = n.subscribeQuery(
    ...
    async (w) => {
      ...
      if (Oe(T && S, "Expected rows and pageInfo"), T.length < o) {
        g(lt, {
          data: T,
...
class ha {
  ...
  shutdown() {
    delete Ct[Ot(this._reactor.config)], this._reactor.shutdown();
  }
  /**
...
function ya(n, e, t, r, s) {
  ...
  return Ct[Ot(i)] = c, ba(i.appId, i.devtool), c;
}
function ba(n, e) {
