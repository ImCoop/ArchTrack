...
var Mi = (n, e, t) => e in n ? Ri(n, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : n[e] = t;
var p = (n, e, t) => Mi(n, typeof e != "symbol" ? e + "" : e, t);
import fs, { useRef as $e, useCallback as Re, useSyncExternalStore as qt, useEffect as We, useMemo as mn, useState as ds, createElement as ji } from "react";
function se(n) {
  if (typeof n == "number")
...
const zt = (n, e, t = !1) => {
  ...
  set(n, e) {
    ...
    return (!r.has(n) || !Me(r.get(n), e)) && (de(t), Ie(t), t.assignedMap.set(n, !0), t.copy.set(n, e), Yn(t, n, e, vt)), this;
  },
  delete(n) {
    if (!this.has(n))
      return !1;
...
const qi = Reflect.ownKeys(Vt), gs = /* @__PURE__ */ new WeakSet(), _s = {
  ...
  set(n, e, t) {
    ...
    return a && Me(a.original, t) ? (n.copy[e] = t, n.assignedMap = (r = n.assignedMap) !== null && r !== void 0 ? r : /* @__PURE__ */ new Map(), n.assignedMap.set(e, !1), !0) : (Me(t, o) && (t !== void 0 || mt(n.original, e)) || (de(n), Ie(n), mt(n.original, e) && Me(t, n.original[e]) ? n.assignedMap.delete(e) : n.assignedMap.set(e, !0), n.copy[e] = t, Yn(n, e, t, vt)), !0);
  },
  has(n, e) {
    return e in me(n);
  },
...
const Qi = (n) => function e(t, r, s) {
  ...
  const C = (v) => {
    const U = D(S);
    if (!qe(v)) {
      if (v !== void 0 && !Me(v, S) && (U != null && U.operated))
...
function _o(n, e, [t]) {
  if (!e.getAttr(t))
    return;
  const r = Rs(n).filter(([s, i]) => i !== t);
  e.deleteAttr(t), Ps(n, e, r);
}
function mo(n, e, [t]) {
  e.getAttr(t.id) && (e.updateAttr(t), Ps(n, e, Rs(n)));
}
function wo(n, e, t) {
  const [r, ...s] = t;
  switch (r) {
...
function ko(n, e, t) {
  const r = t.filter(([s, i, o, a, c]) => {
    ...
    const f = e.getAttr(o);
    if (f) {
      const d = Ms(e, f["forward-identity"][1]);
      l = !!Oo(n, e, [
        i,
        d == null ? void 0 : d.id,
        i
...
function js(n, e, t) {
  return t ? typeof n == "object" ? Ro(n) ? t : null : Io(n)(n, e, t) : null;
}
function Mo(n, e, t) {
...
function jo(n, e, t) {
  return Do(n, e, t).map((r) => Mo(e, r, t)).filter((r) => r);
}
function xo(n, e, t) {
...
function oa(n, e, t, r) {
  const s = Yt;
  return r ? Ds(s, n, e, t, r).concat(Mr(s, n, e, t)) : Mr(s, n, e, t);
}
function aa(n, e, t) {
...
function Pa(n, e, t) {
  if (!Ia(n, e, t))
    return ie(n, e, t);
  const r = Rn(t), s = ie(n, e, r) || Ve(n, e, r);
  ...
  for (const b of t) {
    ...
    if (Va.has(g)) {
      ...
      for (const C of Object.keys(_)) {
        const v = o(m, C);
        if (u(v), Ba.has(g) && (v || c(Rt(e, m, C, C === "id" ? { "unique?": !0 } : null))), Qa.has(g)) {
          const U = a(m, C);
          !v && !U && c(Dr(e, m, C)), u(U);
        }
      }
...
class Zt extends ue {
  constructor(t) {
    ...
    super(r, t.body.hint, ((o = t.body) == null ? void 0 : o.traceId) || t.body["trace-id"]);
    p(this, "body");
    p(this, "status");
...
class Dc {
  ...
  async initSubscription(e, t, r) {
    ...
    if (s && s.state && s.state.txId) {
      this.sendResync(s, s.state, s.state.txId), (u = s.values) != null && u.entities && r && r({
        ...
        data: Mt(s, (l = s.values) == null ? void 0 : l.entities)
      });
      return;
    }
  ...
  onSyncInitFinish(e) {
    ...
    s && this.notifyCbs(r, {
      ...
      data: Mt(s, ((i = s.values) == null ? void 0 : i.entities) || [])
    });
  }
  onSyncUpdateTriples(e) {
    ...
    for (const a of e.txes) {
      ...
      $c(s, g, f), this.notifyCbs(r, {
        ...
        data: Mt(s, (o = s.values) == null ? void 0 : o.entities),
        added: y,
        removed: b,
        updated: d
      });
    ...
    for await (const K of t(H)) {
      ...
      if (K.files && K.files.length) {
        ...
        for (let q = 0; q < K.files.length; q++) {
          const k = K.files[q + 1], M = await ne;
          if (k && (ne = fetch(k.url, { signal: V.signal })), !M.ok) {
            if (_++, _ > 10) {
    ...
    switch (Zr[t.op] || this._log.info("[receive]", e, t.op, t), t.op) {
      ...
      case "refresh-ok": {
        ...
        const S = bn(m.entries()), _ = y.map((w) => {
          var q, k, j, M;
          const C = w["instaql-query"], v = w["instaql-result"], U = se(C), I = qr(v), P = this.ensureAttrs(), H = pt(P, I, r, this.config.useDateObjects), { store: K, attrsStore: G } = this._applyOptimisticUpdates(H, P, S, g), V = (k = (q = v == null ? void 0 : v[0]) == null ? void 0 : q.data) == null ? void 0 : k["page-info"], ne = (M = (j = v == null ? void 0 : v[0]) == null ? void 0 : j.data) == null ? void 0 : M.aggregate;
          return {
            q: C,
            hash: U,
            store: K,
...
const gu = (n) => JSON.stringify(n), bt = (n, e = !1) => JSON.stringify([n, e]), Xr = (n) => {
  ...
  const m = (k) => {
    ...
    var O, A;
    const { cursor: M } = Xr(k), F = f.get(He("reverse", M));
    F == null || F();
    const N = n.subscribeQuery({
      ...
      ut(J && X, "Expected query subscription to contain rows and pageInfo"), w(M, {
        data: J,
        status: "frozen",
    ...
    f.set(He("forward", k, j), M);
  }, I = (k, j = !1) => {
    var A, W;
    const M = bt(k, j), F = f.get(He("forward", k, j));
    F == null || F();
    const N = u.get(M);
    ...
    if (!k)
      return;
    const [j, M] = k;
    if (!(M != null && M.hasMore) || !_u(M))
      return;
    const F = `${j}:${gu(M.endCursor)}`;
    F != b && (b = F, C(j, M), v(M.endCursor));
  }, H = () => {
  ...
  return g = n.subscribeQuery({
    ...
    if (k.error)
      return m(k.error);
    const j = k.pageInfo[a], M = (N = k == null ? void 0 : k.data) == null ? void 0 : N[a];
    if (ut(M && j, "Expected rows and pageInfo"), M.length < o) {
      _(gn, {
        data: M,
...
function Ru(n, e, t, r, s) {
  ...
  return Dn[$n(i)] = c, Mu(i.appId, i.devtool), c;
}
function Mu(n, e) {
...
function xu() {
  ...
  return n.NODE_ENV !== "production" && function() {
    ...
    function C(h, T, E) {
      {
        var R = _.ReactDebugCurrentFrame, z = R.getStackAddendum();
        z !== "" && (T += "%s", E = E.concat([z]));
    ...
    var k = Object.assign, j = 0, M, F, N, O, A, W, J;
    function X() {
    }
    ...
    function le() {
      {
        if (j === 0) {
          M = console.log, F = console.info, N = console.warn, O = console.error, A = console.group, W = console.groupCollapsed, J = console.groupEnd;
          var h = {
            configurable: !0,
            enumerable: !0,
            value: X,
    ...
    function Ct(h, T, E) {
      ...
      if (typeof h == "object")
        switch (h.$$typeof) {
          ...
          case y: {
            var R = h, z = R._payload, Q = R._init;
            try {
              return Ct(Q(z), T, E);
            } catch {
            }
          ...
          if (Q(h, L)) {
            ...
            try {
              if (typeof h[L] != "function") {
                var fe = Error((R || "React class") + ": " + E + " type `" + L + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof h[L] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw fe.name = "Invariant Violation", fe;
              }
              $ = h[L](T, L, R, E, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (ee) {
              $ = ee;
            }
            $ && !($ instanceof Error) && (It(z), w("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", R || "React class", E, L, typeof $), It(null)), $ instanceof Error && !($.message in cr) && (cr[$.message] = !0, It(z), w("Failed %s type: %s", E, $.message), It(null));
          }
      }
    }
    ...
    function wi(h, T, E, R, z) {
      {
        ...
        return mi(h, $, fe, z, R, dr.current, L);
      }
    }
    ...
    function _r(h, T) {
      {
        ...
        gr[E] = !0;
        var R = "";
        h && h._owner && h._owner !== sn.current && (R = " It was passed a child from " + q(h._owner.type) + "."), Qe(h), w('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', E, R), Qe(null);
      }
    }
    function mr(h, T) {
      {
    ...
    function Ei(h) {
      {
        for (var T = Object.keys(h.props), E = 0; E < T.length; E++) {
          var R = T[E];
          if (R !== "children" && R !== "key") {
            Qe(h), w("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", R), Qe(null);
            break;
          }
        }
...
function Uu(n, e, t, r) {
  ...
  const s = e ? ri(e) : null, i = se(s), o = $e(is(n._reactor.getPreviousResult(s))), a = $e(Du), c = Re(
...
function qu(n, e) {
  return We(() => n.core._reactor.joinRoom(n.type, n.id), [n.id]), Re((r) => {
...
function Qu(n, e, t = {}) {
  ...
  }, [t == null ? void 0 : t.writeOnly, s]), o = Re((l) => {
  ...
  }, [n.type, n.id, e, t == null ? void 0 : t.timeout, r]), a = Re((l) => {
    const d = !((t == null ? void 0 : t.stopOnEnter) && l.key === "Enter");
    o(d);
  }, [t.stopOnEnter, o]), c = Re(() => {
    o(!1);
...
class Nt {
  constructor(e, t) {
    ...
    p(this, "useConnectionStatus", () => {
      const e = $e(this.core._reactor.status), t = Re((s) => this.core.subscribeConnectionStatus((o) => {
  ...
  _useAuth() {
    const e = $e(this.core._reactor._currentUserCached), t = Re((s) => this.core.subscribeAuth((o) => {
